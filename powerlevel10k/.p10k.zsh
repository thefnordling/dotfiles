...
# Example: make the background darker and text lighter
typeset -g POWERLEVEL9K_DIR_BACKGROUND=238  # Dark gray background
typeset -g POWERLEVEL9K_DIR_FOREGROUND=255  # White text

# Or for the prompt segment you’re seeing (likely current directory)
typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=255
typeset -g POWERLEVEL9K_DIR_SHORTENED_BACKGROUND=238
