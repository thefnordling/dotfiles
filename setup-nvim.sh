...
sudo apt install -y --no-install-recommends git build-essential unzip curl xclip ripgrep fd-find fontconfig fonts-noto-color-emoji make gcc zsh netcat-openbsd
